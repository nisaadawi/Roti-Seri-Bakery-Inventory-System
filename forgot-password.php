...
if($query -> rowCount() > 0)
{
  ...
  $mail->setFrom($email, "Roti Sri Bakery | Inventory System");
...
https://humancc.site/ndhos/inventory_rsb/reset_password.php
...
<html>
<head>
<title>RSB | Change your Password</title>
...
<!--header-->
		...
		<div class="contact">
			...
			<div class="container">
                ...
                <h6 class="font-weight-light">Enter your Email Address to continue reset password!</h6>
